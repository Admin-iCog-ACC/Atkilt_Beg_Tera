import 'package:retailer_app/serializers/payment.dart';
...
class PaymentMethod {
  ...
  PaymentMethod.fromJson(Map<String, dynamic> parsedJson) {
    id = parsedJson['id'];
    title = parsedJson['title'] ?? parsedJson['method_title'];
  ...
  PaymentMethod.fromStrapiJson(Map<String, dynamic> parsedJson) {
    ...
    try {
      ...
      print('Error on Payment Models Strapi: $e trace: ${trace.toString()}');
    }
  }
}
